...
public class DateTimeInterval {
    ...
    private static DateTimeInterval toMidnight(LocalDateTime from){
    ...
    private static DateTimeInterval during(LocalDate date) {
        return new DateTimeInterval(
            LocalDateTime.of(date,LocalTime.of(0,0)),LocalDateTime.of(date,LocalTime.of(23,59,59,999_999_999))
        );
    }
